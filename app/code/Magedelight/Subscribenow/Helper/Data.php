...
class Data extends AbstractHelper
{
    ...
    {
        $isAllow = $this->scopeConfig->getValue(self::XML_PATH_CUSTOMER_GROUP_VIEW_SUBSCRIPTION, ScopeInterface::SCOPE_WEBSITE);
        return $isAllow;
    }

    public function getNotAllowedCustomerMessage()
    {
        $message = $this->scopeConfig->getValue(self::XML_PATH_CUSTOMER_GROUP_SUBSCRIPTION_MSG, ScopeInterface::SCOPE_WEBSITE);
        return $message;
    }
