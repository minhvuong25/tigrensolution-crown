...
function UGSlider(){
	...
	//	trace("start action");
		...
		switch(objItem.type){
			...
			break;
			case "html5video":
				g_objVideoPlayer.playHtml5Video(objItem.videoogv, objItem.videowebm, objItem.videomp4,objItem.videoflv, objItem.urlImage);
			break;
			case "soundcloud":
...
function UGHtml5MediaAPI(){
	...
	this.loadAPI = function(){
		...
		g_ugFunctions.loadJs("cdnjs.cloudflare.com/ajax/libs/mediaelement/4.2.7/mediaelement.min.js", true);
		
		//g_ugFunctions.loadJs("cdnjs.cloudflare.com/ajax/libs/mediaelement/2.18.1/mediaelement.min.js", true);
		g_ugFunctions.loadCss("cdnjs.cloudflare.com/ajax/libs/mediaelement/4.2.7/mediaelementplayer.min.css", true);
	...
	function putVideoActually(divID, data, width, height, isAutoplay){
		...
		if(data.flv != "")
			html += "<source type='video/flv' src='"+data.flv+"' />";
...
function UGVideoPlayer(){
	 ...
	 * play html5 video
	 */
	this.playHtml5Video = function(ogv, webm, mp4,flv, posterImage, isAutoplay){
		 ...
		 switch(objItem.type){
			...
			break;
		 	...
		 	case "html5video":
		 		...
		 		objItem.videoflv = objChild.data("videoflv");
