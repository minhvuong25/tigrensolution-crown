...
class CreateCampaignsWithStepsAndReminders implements UpgradeDataOperationInterface
{
    ...
    private function updateCampaignStepByOldConfigProvider(
        ...
        return $campaignStep
            ...
            ->setDiscountStatus((int)$oldConfigIsGenerateDiscount)
     ...
     * @return array
     */
    private function getRemindersData(ModuleDataSetupInterface $setup, array $storeIds = [])
    {
