...
class Themecfg extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        ...
        $productZoom = (isset($this->_themeCfg['product_page']['zoom']) && $this->_themeCfg['product_page']['zoom']) ? 'product_zoom' : '';
        if($productZoom) $context->getPageConfig()->addBodyClass($productZoom);
