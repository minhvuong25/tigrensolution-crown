...
class Shipping extends AbstractHelper
{
    ...
    {
        return $this->scopeConfig->getValue(Data::XML_PATH_SUBSCRIBENOW_ACTIVE, ScopeInterface::SCOPE_STORE);
    }
    ...
    {
        return $this->scopeConfig->getValue(Data::XML_PATH_SUBSCRIPTION_FREE_SHIPPING, ScopeInterface::SCOPE_WEBSITE);
    }
